...
void func_808C1190(s16* arg0, u8* arg1, s16 arg2) {
    arg0 = ResourceMgr_LoadTexDataByName(arg0);
...
void func_808C1554(void* arg0, void* floorTex, s32 arg2, f32 arg3) {
    ...
    floorTex = ResourceMgr_LoadTexDataByName(floorTex);
...
void BossDodongo_Init(Actor* thisx, PlayState* play) {
    ...
    if (Flags_GetClear(play, play->roomCtx.curRoom.num)) { // KD is dead
        u16* LavaFloorTex = ResourceMgr_LoadTexDataByName(gDodongosCavernBossLavaFloorTex);
        u16* LavaFloorRockTex = ResourceMgr_LoadTexDataByName(sLavaFloorRockTex);
...
void BossDodongo_Update(Actor* thisx, PlayState* play2) {
    ...
    if (this->unk_1C6 != 0) {
        u16* ptr1 = ResourceMgr_LoadTexDataByName(sLavaFloorLavaTex);
        u16* ptr2 = ResourceMgr_LoadTexDataByName(sLavaFloorRockTex);
        s16 i2;
