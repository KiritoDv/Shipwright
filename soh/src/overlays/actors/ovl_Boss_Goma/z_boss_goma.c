...
void BossGoma_ClearPixels(u8* clearPixelTable, s16 i) {
    BossGoma_ClearPixels16x16Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaBodyTex)), clearPixelTable, i);
    BossGoma_ClearPixels16x16Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaShellUndersideTex)), clearPixelTable, i);
    BossGoma_ClearPixels16x16Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaDarkShellTex)), clearPixelTable, i);
    BossGoma_ClearPixels16x16Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaEyeTex)), clearPixelTable, i);

    BossGoma_ClearPixels32x32Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaShellTex)), clearPixelTable, i);
    BossGoma_ClearPixels32x32Rgba16(ResourceMgr_LoadTexDataByName(SEGMENTED_TO_VIRTUAL(gGohmaIrisTex)), clearPixelTable, i);
}
