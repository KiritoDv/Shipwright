    ...
    switch (play->sceneNum) {
        ...
        case SCENE_GANON_TOU:
            ...
            if (sEntranceIconMapIndex < 24) {
                play->interfaceCtx.mapSegment[0] = strdup(minimapTableOW[sEntranceIconMapIndex]);
            }
        ...
        case SCENE_HAKADAN_BS:
            ...
            play->interfaceCtx.mapSegment[0] = strdup(minimapTableDangeon[gMapData->dgnMinimapTexIndexOffset[mapIndex] + room]);
