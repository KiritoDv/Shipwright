...
void func_801109B0(PlayState* play) {
    ...
    interfaceCtx->doActionSegment[0] = fstrdup(gAttackDoActionENGTex);
    interfaceCtx->doActionSegment[1] = fstrdup(gCheckDoActionENGTex);
    interfaceCtx->doActionSegment[2] = fstrdup(gReturnDoActionENGTex);
